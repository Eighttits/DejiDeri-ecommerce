<footer class="footer footer-margin">
                    ...
                    <div class="footer-row flex-space-between align-items-center">
                        <div class="logo">
                            <a class="logo-link" href="01-home-ds.html">
                                <div class="logo-img"><img src="resources/svg/logo-ds.svg" alt="logo"></div>
  ...
  <script defer src="resources/js/countdown.js"></script>
  <script defer src="resources/js/waves.min.js"></script>
  <script async src="resources/js/svg-loader.js"></script>
  <script defer src="resources/js/nice-select2.js"></script>
